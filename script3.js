...
function openPopup(){
    ...
    var score = document.getElementById('score-3').innerHTML;
    result.textContent = score;
    popup.classList.add("open-popup-3");
    audio.pause();
}

function closePopup(){
    popup.classList.remove("open-popup-3");
    location.reload();
}

document.getElementById("menuButton-3").addEventListener("click", function() {
...
function setBackgroundMoving() {
    if (gerak == true) {
        backgroundTimeout = setTimeout(function () {
            var bg = document.getElementById('main-3');
            bg.style.backgroundPositionY = (parseInt(bg.style.backgroundPositionY.replace('px', '')) + 1) + 'px';
            var scoreElement = document.getElementById('score-3');
...
function setMeteorMoving() {
    var meteor = document.getElementById('meteor-3');
    var plane = document.getElementById('plane-3');
